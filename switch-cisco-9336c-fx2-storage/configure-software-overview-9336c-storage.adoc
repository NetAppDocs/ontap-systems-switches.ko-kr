...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["네"]link:install-upgrade-rcf-overview-9336c-storage.html["RCF를 설치하거나 업그레이드합니다"]
[role="quick-margin-para"]
