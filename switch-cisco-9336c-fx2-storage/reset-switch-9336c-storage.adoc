...
summary: 현재 스위치 구성을 지워 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스토리지 스위치를 공장 기본값으로 재설정합니다. 
---
= Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스토리지 스위치를 공장 초기 설정으로 재설정합니다.
:allow-uri-read: 


[role="lead"]
Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스토리지 스위치를 공장 기본값으로 재설정하려면 현재 스위치 구성을 지우고 스위치를 원래 설정으로 복원하십시오.
...
.다음은 무엇입니까?
스위치를 재설정한 후에는 다음을 수행할 수 있습니다.link:configure-switch-overview-9336c-storage.html["재구성하다"] 필요에 따라.
