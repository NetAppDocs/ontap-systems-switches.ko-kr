...
summary: 'Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스토리지 스위치에서 새 버전이 출시되면 참조 구성 파일(RCF)을 업그레이드하십시오.' 
---
= Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스토리지 스위치의 RCF 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스토리지 스위치에서 새로운 버전의 참조 구성 파일(RCF)이 제공되면 RCF(참조 구성 파일)를 업그레이드하십시오.
