...
.다음 단계
필요에 따라 할 수 있습니다 link:install-switch-and-passthrough-panel-9336c-storage.html["NetApp 캐비닛에 Cisco Nexus 9336C-FX2 스위치를 설치합니다"]. 그렇지 않으면 로 이동합니다 link:install-nxos-overview-9336c-storage.html["NX-OS 및 RCF 설치 준비"].
