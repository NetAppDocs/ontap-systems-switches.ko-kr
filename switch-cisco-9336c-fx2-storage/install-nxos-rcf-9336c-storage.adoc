...
시작하기 전에 의 절차를 완료하십시오 link:install-nxos-overview-9336c-storage.html["NX-OS 및 RCF 설치 준비"].
...
====
+
을 참조하십시오 https://www.cisco.com/c/en/us/td/docs/dcn/nx-os/nexus9000/103x/configuration/fundamentals/cisco-nexus-9000-nx-os-fundamentals-configuration-guide-103x/m-using-poap.html?bookSearch=true#id_85315["PowerOn 자동 프로비저닝 사용"^] 를 참조하십시오.
