...
summary: Cisco Nexus 9364D-GX2A 스위치의 NX-OS를 업그레이드하여 AFX 1K 또는 AFX 2K 시스템의 새로운 하드웨어 또는 새로운 ONTAP 버전을 지원합니다. 
---
= Cisco Nexus 9364D-GX2A 스위치의 NX-OS 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9364D-GX2A 스위치의 NX-OS를 업그레이드하여 AFX 1K 또는 AFX 2K 시스템의 새로운 하드웨어 또는 새로운 ONTAP 버전을 지원합니다.
...
.다음은 무엇인가요?
스위치의 NX-OS를 업그레이드한 후에는 link:configure-install-upgrade-rcf-overview-9364d.html["RCF 설치 또는 업그레이드 개요"]부터 시작하여 RCF를 업그레이드합니다.
