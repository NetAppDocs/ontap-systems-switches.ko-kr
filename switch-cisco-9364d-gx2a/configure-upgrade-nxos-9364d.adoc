...
summary: Cisco Nexus 9364D-GX2A 스위치의 NX-OS를 업그레이드하여 AFX 1K 또는 AFX 2K 시스템의 새로운 하드웨어 또는 새로운 ONTAP 버전을 지원할 수 있습니다. 
---
= NX-OS 업그레이드 - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9364D-GX2A 스위치의 NX-OS를 업그레이드하여 AFX 1K 또는 AFX 2K 시스템의 새로운 하드웨어 또는 새로운 ONTAP 버전을 지원할 수 있습니다.
