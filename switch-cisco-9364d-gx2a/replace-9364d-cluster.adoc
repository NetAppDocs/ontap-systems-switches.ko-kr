...
summary: AFX 시스템에서 고장난 Cisco Nexus 9364D-GX2A 스위치를 시스템 운영 중단 없이 교체합니다. 이 작업은 시스템 운영 중단 없이 진행됩니다. 
---
= AFX 시스템에서 Cisco Nexus 9364D-GX2A 스위치를 교체합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFX 시스템에서 작동을 중단하지 않고 결함이 있는 Cisco Nexus 9364D-GX2A 스위치를 교체합니다. 이 비중단 절차(NDU)는 교체 스위치를 준비하고 시스템 구성을 복원하는 작업을 포함합니다.
...
** 스위치의 초기 사용자 지정이 완료되었으며, 자세한 내용은 link:configure-complete-initial-setup-9364d.html["스위치 초기 설정 완료"]에 설명되어 있습니다.
+
