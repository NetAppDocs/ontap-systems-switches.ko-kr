...
summary: 새로운 AFX 1K 또는 AFX 2K 시스템 설치, 스위치 교체 또는 공장 초기화 시 Cisco Nexus 9364D-GX2A 스위치에 NX-OS를 설치하십시오. 
---
= Cisco Nexus 9364D-GX2A 스위치에 NX-OS를 설치합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
새로운 AFX 1K 또는 AFX 2K 시스템 설치, 스위치 교체 또는 스위치를 공장 초기 설정으로 재설정할 때 Cisco Nexus 9364D-GX2A 스위치에 NX-OS를 설치하십시오.
...
+
** 스위치에 현재 NetApp에서 지원하는 버전이 설치되어 있는 경우 NX-OS를 설치할 필요가 없습니다. RCF를 설치해야 합니다. link:configure-install-upgrade-rcf-overview-9364d.html["RCF 설치 또는 업그레이드 개요"]부터 시작하십시오.
...
.다음은 무엇인가요?
스위치에 NX-OS를 설치한 후에는 link:configure-install-upgrade-rcf-overview-9364d.html["RCF 설치 또는 업그레이드 개요"]부터 시작하여 RCF를 설치합니다.
