...
summary: Cisco Nexus 9364D-GX2A 스위치에 NX-OS를 설치하는 과정은 새로운 AFX 1K 또는 AFX 2K 시스템 설치, 스위치 교체 또는 스위치를 공장 초기 설정으로 재설정하는 과정의 일부입니다. 
---
= NX-OS 설치 - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9364D-GX2A 스위치에 NX-OS를 설치하는 과정은 새로운 AFX 1K 또는 AFX 2K 시스템 설치, 스위치 교체 또는 스위치를 공장 초기 설정으로 재설정하는 과정의 일부입니다.
