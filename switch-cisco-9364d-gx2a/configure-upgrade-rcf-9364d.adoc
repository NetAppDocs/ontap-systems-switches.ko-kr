...
summary: AFX 1K 또는 AFX 2K 시스템에서 새로운 하드웨어, 새로운 ONTAP 버전 또는 새로운 NX-OS 버전을 지원하기 위해 Cisco Nexus 9364D-GX2A 스위치의 RCF를 업그레이드합니다. 
---
= Cisco Nexus 9364D-GX2A 스위치의 RCF 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9364D-GX2A 스위치의 참조 구성 파일(RCF)을 업그레이드하여 AFX 1K 또는 AFX 2K 시스템의 새로운 하드웨어, 새로운 ONTAP 버전 또는 새로운 NX-OS 버전을 지원합니다.
