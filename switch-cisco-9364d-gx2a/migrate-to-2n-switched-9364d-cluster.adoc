...
summary: 기존에 2노드 스위치리스 클러스터 환경이 있는 경우 Cisco Nexus 9364d-gx2a 스위치를 사용하여 2노드 스위치 클러스터 환경으로 마이그레이션하면 클러스터에서 노드를 두 개 이상으로 확장할 수 있습니다. 
---
...
[role="lead"]
기존의 2노드 _스위치리스_ 클러스터 환경이 있는 경우 Cisco Nexus 9364D-GX2A 스위치를 사용하여 2노드 _스위치_ 클러스터 환경으로 마이그레이션할 수 있습니다.
...
** 지원되는 모든 ONTAP 버전은 link:https://hwu.netapp.com["Hardware Universe"^]을 참조하십시오.
...
+
케이블 연결에 대한 자세한 내용은 link:https://hwu.netapp.com["Hardware Universe"^]를 참조하십시오.
...
사용 중인 플랫폼의 클러스터 포트에 대한 자세한 내용은 link:https://hwu.netapp.com["Hardware Universe"^]를 참조하십시오.
