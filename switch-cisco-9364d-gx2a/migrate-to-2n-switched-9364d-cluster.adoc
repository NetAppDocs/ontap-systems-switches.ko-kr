...
** 을 참조하십시오 https://hwu.netapp.com["Hardware Universe"^] 지원되는 모든 ONTAP 버전.
...
+
을 참조하십시오 https://hwu.netapp.com["Hardware Universe"^] 케이블 연결에 대한 자세한 내용은 를 참조하십시오.
...
. 노드 2의 클러스터 포트 e0a에서 케이블을 분리한 다음, 9332D-GX2B 스위치에서 지원하는 적절한 케이블을 사용하여 e0a를 클러스터 스위치 cs1의 포트 2에 연결합니다.
