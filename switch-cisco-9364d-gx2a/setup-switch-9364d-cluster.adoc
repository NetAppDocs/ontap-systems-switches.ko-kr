...
summary: Cisco Nexus 9364d-gx2a 스위치를 설정하고 구성하려면 다음 절차를 따르세요. 
---
= 9364D-GX2A 스위치 구성
:allow-uri-read: 
:icons: font
...
[role="lead"]
Cisco Nexus 9364D-GX2A 스위치를 구성하려면 다음 절차를 따르세요.
...
* link:required-documentation-9364d-cluster.html["필수 스위치 및 ONTAP 문서"] .
...
.다음 단계
스위치를 구성한 후에는link:install-nxos-overview-9364d-cluster.html["NX-OS 및 RCF 설치 준비"] .
