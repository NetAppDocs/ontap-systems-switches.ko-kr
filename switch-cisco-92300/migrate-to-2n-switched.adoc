...
summary: 기존의 2노드 스위치가 없는 클러스터를 Cisco Nexus 92300YC 클러스터 스위치를 사용하는 스위치 클러스터 환경으로 마이그레이션합니다. 
---
= Cisco Nexus 92300YC 클러스터 스위치를 사용하여 2노드 스위치 클러스터로 마이그레이션
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
기존의 2노드 스위치가 없는 클러스터를 Cisco Nexus 92300YC 클러스터 스위치를 사용하는 스위치드 클러스터 환경으로 마이그레이션하십시오. 이 무중단 마이그레이션을 통해 클러스터를 2개 이상의 노드로 확장할 수 있습니다.
