...
+
Hardware Universe*에는 케이블 연결에 대한 자세한 정보가 포함되어 있습니다.
...
+
Hardware Universe * 에는 플랫폼의 실제 클러스터 포트에 대한 최신 정보가 들어 있습니다.
...
+
시스템 cluster-switch log setup-password 'system cluster-switch log enable-collection'
