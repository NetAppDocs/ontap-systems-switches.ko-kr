...
* Cisco 스위치 업그레이드 및 다운그레이드 절차에 대한 자세한 내용을 _Cisco Nexus 9000 시리즈 스위치_ 에 보려면 Cisco 웹 사이트에서 제공되는 적절한 소프트웨어 및 업그레이드 가이드를 참조해야 합니다.
+
https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 9000 시리즈 스위치"]
