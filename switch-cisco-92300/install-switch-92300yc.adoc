...
* 완전한link:setup-worksheet-92300yc.html["케이블 연결 워크시트"] .
...
.다음 단계
선택적으로 다음을 수행할 수 있습니다.link:install-switch-netapp-cabinet-92300yc.html["NetApp 캐비닛에 Cisco Nexus 3223C 스위치 설치"] .  그렇지 않으면 다음으로 이동하세요link:cabling-considerations-92300.html["케이블 연결 및 구성을 검토합니다"] .
