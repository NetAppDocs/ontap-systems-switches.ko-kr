...
summary: NetApp CN1610 클러스터 스위치를 클러스터 운영을 중단하지 않고 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치로 마이그레이션합니다. 
---
= NetApp CN1610 클러스터 스위치에서 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치로 마이그레이션
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
기존 NetApp CN1610 클러스터 스위치를 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치로 클러스터 운영을 중단 없이 마이그레이션합니다.
