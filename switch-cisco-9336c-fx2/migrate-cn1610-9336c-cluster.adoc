...
지원되는 포트 및 구성에 대한 자세한 내용은 link:https://hwu.netapp.com/["Hardware Universe"^]을(를) 참조하십시오. 스위치 설치 요구 사항에 대한 자세한 내용은 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["HWU에 없는 추가 정보 중 장비를 설치하는 데 필요한 정보는 무엇입니까?"^]을(를) 참조하십시오.
