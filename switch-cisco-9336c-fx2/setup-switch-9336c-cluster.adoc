...
---
= 9336C-FX2 및 9336C-FX2-T 클러스터 스위치 구성
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 및 9336C-FX2-T 스위치를 구성하려면 다음 절차를 따르세요.
...
.다음 단계
스위치를 구성한 후에는 다음을 수행할 수 있습니다. link:install-nxos-overview-9336c-cluster.html["NX-OS 소프트웨어와 RCF 설치를 준비합니다"].
