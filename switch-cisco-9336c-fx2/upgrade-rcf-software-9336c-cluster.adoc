...
summary: 'Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치의 참조 구성 파일(RCF)에 새 버전이 출시되면 해당 파일을 업그레이드하십시오.' 
---
= Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치의 RCF를 업그레이드합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치에서 새로운 버전의 RCF(참조 구성 파일)가 제공되면 해당 파일을 업그레이드하십시오.
...
. FTP, SFTP 또는 SCP 중 하나의 전송 프로토콜을 사용하여 RCF를 스위치 cs1의 bootflash에 복사하십시오.
+
...
+
이 예에서는 SFTP를 사용하여 스위치 cs1의 bootflash에 RCF를 복사하는 방법을 보여줍니다.
...
CAUTION: RCF 업그레이드 후 9336C-FX2 스위치가 부팅되지 않으면 NetApp 기술 자료 문서 link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared["RCF 설치 후 Cisco 9336C-FX2 스위치 부팅 실패 – 부팅 변수 지워짐"^]를 참조하여 다음 단계를 진행하십시오.
