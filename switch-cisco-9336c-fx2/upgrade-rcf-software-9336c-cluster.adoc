...
+
Cisco 명령에 대한 자세한 내용은 해당 가이드를 참조하세요.link:https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Cisco Nexus 9000 Series NX-OS 명령 참조"^] .
