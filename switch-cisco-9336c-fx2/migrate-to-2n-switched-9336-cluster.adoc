...
[role="lead"]
기존의 2노드_스위치 없는_클러스터 환경이 있는 경우 Cisco Nexus 9336C-FX2 스위치를 사용하여 2노드_Switched_cluster 환경으로 마이그레이션할 수 있습니다.
...
** 을 참조하십시오 https://["Hardware Universe"^] 지원되는 모든 ONTAP 버전.
...
+
을 참조하십시오 https://["Hardware Universe"^] 케이블 연결에 대한 자세한 내용은 를 참조하십시오.
...
을 참조하십시오 https://["Hardware Universe"^] 플랫폼을 위한 클러스터 포트에 대한 자세한 내용은 를 참조하십시오.
...
+
를 클릭합니다 https://["Hardware Universe - 스위치"^] 케이블 연결에 대한 자세한 내용은 에 나와 있습니다.

+
https://["Hardware Universe - 스위치"^]
