...
. link:setup-worksheet-9336c-cluster.html["Cisco Nexus 9336C-FX2 또는 9336C-FX2-T 케이블 연결 워크시트를 작성합니다"]..
+
...
. link:install-upgrade-rcf-overview-cluster.html["RCF를 설치하거나 업그레이드합니다"]..
+
