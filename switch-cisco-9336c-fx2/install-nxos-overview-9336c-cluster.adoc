...
summary: 'NX-OS 소프트웨어와 참조 구성 파일(RCF)을 설치하기 전에 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치를 준비하십시오.' 
---
= Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치에 NX-OS 소프트웨어와 RCF를 설치할 준비를 합니다.
:allow-uri-read: 


[role="lead"]
NX-OS 소프트웨어와 참조 구성 파일(RCF)을 설치하기 전에 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치를 준비하십시오. 스위치가 ONTAP 클러스터에서 작동하려면 NX-OS와 RCF를 설치해야 합니다.
