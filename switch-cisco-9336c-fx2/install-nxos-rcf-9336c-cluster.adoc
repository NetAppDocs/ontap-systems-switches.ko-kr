...
이 절차의 예에서는 4개의 노드를 사용합니다. 이러한 노드에는 10GbE 클러스터 인터커넥트 포트 2개 e0a 및 e0b가 사용됩니다. 를 참조하십시오 https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"] 사용 중인 플랫폼에서 올바른 클러스터 포트를 확인하려면 다음을 수행합니다.
...
.다음 단계
link:../switch-cisco-9336c-fx2-storage/configure-ssh.html["SSH를 활성화합니다"]..
...
. 이전에 식별된 사용자 지정 추가 사항을 스위치 구성에 다시 적용합니다.
