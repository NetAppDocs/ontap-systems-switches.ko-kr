...
summary: '초기 설정 후 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치에 참조 구성 파일(RCF)을 설치하여 포트 할당, VLAN 및 네트워크 설정을 구성하십시오.' 
---
= Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치에 RCF를 설치합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
초기 설정 후 Cisco Nexus 9336C-FX2 및 9336C-FX2-T 클러스터 스위치에 참조 구성 파일(RCF)을 설치하십시오. RCF는 클러스터 작동에 필요한 포트 할당, VLAN 및 네트워크 설정을 정의합니다.
