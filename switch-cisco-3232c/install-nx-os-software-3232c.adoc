...
summary: 다음 절차를 사용하여 Nexus 3232C 클러스터 스위치에 NX-OS 소프트웨어를 설치할 수 있습니다. 
---
= NX-OS 소프트웨어 설치
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음 절차를 사용하여 Nexus 3232C 클러스터 스위치에 NX-OS 소프트웨어를 설치할 수 있습니다.
...
+
자세한 내용은 link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD 업그레이드 릴리스 노트, 릴리스 9.3(11)"^]을(를) 참조하십시오.
...
.다음은 무엇인가요?
NX-OS 소프트웨어를 설치한 후에는 다음을 수행할 수 있습니다. link:install-upgrade-rcf-overview-3232c.html["참조 구성 파일(RCF) 설치 또는 업그레이드"].
