...
summary: CSHM 및 로그 수집을 지원하려면 Cisco Nexus 3232C 클러스터 스위치에서 SSH 및 SSH 키가 활성화되어 있는지 확인하십시오. 
---
= Cisco Nexus 3232C 클러스터 스위치의 SSH 구성을 확인합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3232C 클러스터 스위치에서 SSH 및 SSH 키가 활성화되어 있는지 확인하여 이더넷 스위치 상태 모니터(CSHM) 및 로그 수집 기능을 지원하도록 하십시오.
