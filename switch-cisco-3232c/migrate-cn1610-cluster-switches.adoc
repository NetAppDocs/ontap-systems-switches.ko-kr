...
+
Cisco 명령에 대한 자세한 내용은 에 나와 있는 가이드를 참조하십시오 https://["Cisco Nexus 3000 시리즈 NX-OS 명령 참조"^].
...
----
====
. 첫 번째 CN1610 스위치 CL1에 연결된 LIF 마이그레이션:
+
...
----
====
. [[40]] 스위치 관련 로그 파일 수집을 위한 클러스터 스위치 상태 모니터 로그 수집 기능을 활성화합니다.
+
