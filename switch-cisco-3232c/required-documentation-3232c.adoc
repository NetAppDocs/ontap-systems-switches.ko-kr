...
Cisco Nexus 3232C 스위치를 설정하려면 의 다음 설명서가 필요합니다 https://["Cisco Nexus 3000 시리즈 스위치 지원"^] 페이지.
...
42U 시스템 캐비닛과 관련된 FRU에 대해 설명하고 유지보수 및 FRU 교체 지침을 제공합니다.
 ...
 a| 
link:install-cisco-nexus-3232c.html["NetApp 캐비닛에 Cisco Nexus 3232C 스위치를 설치합니다"^]
 a| 
