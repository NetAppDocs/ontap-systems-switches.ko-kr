...
summary: Nexus 3232C 스위치를 처음 설정한 후 RCF를 설치할 수 있습니다. 이 절차를 사용하여 RCF 버전을 업그레이드할 수도 있습니다. 
---
...
[role="lead"]
처음으로 Nexus 3232C 스위치를 설정한 후 RCF를 설치하려면 다음 절차를 따르세요.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco 이더넷 스위치 페이지"^]지원되는 ONTAP 및 RCF 버전에 대한 스위치 호환성 표를 참조하세요.  RCF의 명령 구문과 NX-OS 버전에서 발견되는 명령 구문 사이에는 명령 종속성이 있을 수 있습니다.
* link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 시리즈 스위치"^]. Cisco 스위치 업그레이드 및 다운그레이드 절차에 대한 전체 문서는 Cisco 웹 사이트에서 제공하는 해당 소프트웨어 및 업그레이드 가이드를 참조하세요.
...
. 현재 사이의 사용자 정의 추가 사항을 기록합니다. `running-config` 그리고 RCF 파일을 사용 중입니다.
...
. FTP, TFTP, SFTP 또는 SCP 중 하나의 전송 프로토콜을 사용하여 RCF를 스위치 cs2의 bootflash에 복사하십시오. Cisco 명령에 대한 자세한 내용은 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 시리즈 NX-OS 명령 참조"^]의 해당 가이드를 참조하십시오.
+
.예를 보여주세요
[%collapsible]
====
...
+
Cisco 명령에 대한 자세한 내용은 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 시리즈 NX-OS 명령 참조"^]의 해당 가이드를 참조하십시오.
...
This command will reboot the system. (y/n)?  [n] *y*
----
. 동일한 RCF를 적용하고 실행 구성을 두 번째로 저장합니다.
+
.예를 보여주세요
[%collapsible]
====
