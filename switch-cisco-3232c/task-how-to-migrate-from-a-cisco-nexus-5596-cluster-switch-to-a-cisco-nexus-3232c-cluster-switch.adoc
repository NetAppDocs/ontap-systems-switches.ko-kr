...
[NOTE]
====
이 절차의 예제에서는 4개의 노드를 사용합니다. 두 노드는 e0a, e0b, e0c 및 e0d 4개의 10GbE 클러스터 인터커넥트 포트를 사용합니다. 다른 두 노드는 두 개의 40GbE 클러스터 인터커넥트 포트(e4a, e4e)를 사용합니다. 를 클릭합니다 link:https://hwu.netapp.com/["_Hardware Universe _"^] 에는 플랫폼의 실제 클러스터 포트가 나와 있습니다.
