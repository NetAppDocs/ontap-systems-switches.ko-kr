...
summary: 'Cisco Nexus 3232C 스토리지 스위치의 참조 구성 파일(RCF)에 새 버전이 출시되면 해당 파일을 업그레이드하십시오.' 
---
= Cisco Nexus 3232C 스토리지 스위치의 RCF 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3232C 스토리지 스위치의 참조 구성 파일(RCF)의 최신 버전이 출시되면 해당 파일을 업그레이드하십시오.
...
+
현재 부팅 이미지를 반영하도록 부팅 구성을 변경해야 하는 경우, RCF를 다시 적용하기 전에 변경해야 향후 재부팅 시 올바른 버전이 포함됩니다.
...
+
Cisco 명령에 대한 자세한 내용은 https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html#CommandReferences["Cisco Nexus 3000 시리즈 NX-OS 문서"^]의 해당 가이드를 참조하십시오.
...
+
Cisco 명령에 대한 자세한 내용은 https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html["Cisco Nexus 3000 시리즈 설명서"^]의 해당 가이드를 참조하십시오.

+
이 예시는 스위치 s2에 설치되는 RCF 파일 `NX3232C-RCF-v1.13-1-Storage.txt`을 보여줍니다:
...
+
Cisco 명령에 대한 자세한 내용은 https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html["Cisco Nexus 9000 시리즈 설명서"^]의 해당 가이드를 참조하십시오.
