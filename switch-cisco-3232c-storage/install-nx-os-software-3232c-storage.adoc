...
summary: 이 절차를 사용하여 Nexus 3232C 스토리지 스위치에 NX-OS 소프트웨어를 설치할 수 있습니다. 
---
...
----
====
. NX-OS 버전 9.3(11)으로 업그레이드하는 경우 EPLD를 업그레이드해야 합니다. `golden` 이미지를 다시 한 번 스캔하고 스위치를 재부팅합니다.  그렇지 않으면 12단계로 건너뜁니다.
+
보다 https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD 업그레이드 릴리스 노트, 릴리스 9.3(11)"^] 자세한 내용은.
...
----
====
. 스위치를 재부팅한 후 로그인하여 새로운 버전의 EPLD가 성공적으로 로드되었는지 확인하세요.
+
.예를 보여주세요
[%collapsible]
====
