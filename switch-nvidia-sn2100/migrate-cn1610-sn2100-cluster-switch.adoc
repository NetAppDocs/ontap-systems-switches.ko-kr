...
NetApp CN1610 클러스터 스위치를 NVIDIA SN2100 클러스터 스위치로 교체할 때는 특정 구성 정보, 포트 연결 및 케이블 요구 사항을 숙지해야 합니다. link:configure-overview-sn2100-cluster.html["NVIDIA SN2100 스위치 설치 및 구성 개요"]을 참조하십시오.
...
지원되는 포트 및 구성에 대한 자세한 내용은 link:https://hwu.netapp.com/["Hardware Universe"^]을 참조하십시오.
...
--
====
. [[step5]]스위치 c2에서 클러스터 LIF를 장애 조치하기 위해 노드의 클러스터 포트에 연결된 포트를 종료합니다.
+
[listing, subs="+quotes"]
----
(c2)# *configure*
