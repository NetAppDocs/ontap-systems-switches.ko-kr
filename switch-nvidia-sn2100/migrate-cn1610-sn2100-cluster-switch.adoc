...
summary: 클러스터 운영을 중단하지 않고 기존 NetApp CN1610 클러스터 스위치를 NVIDIA SN2100 클러스터 스위치로 마이그레이션하십시오. 
---
= NetApp CN1610 클러스터 스위치에서 NVIDIA SN2100 클러스터 스위치로 마이그레이션
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
클러스터 운영을 중단하지 않고 기존 NetApp CN1610 클러스터 스위치를 NVIDIA SN2100 클러스터 스위치로 마이그레이션하십시오.
