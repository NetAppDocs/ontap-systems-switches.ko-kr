...
IMPORTANT: 주의사항 및 자세한 내용은 link:cabling-considerations-sn2100-cluster.html["케이블링 및 구성 지침을 검토하십시오."]을(를) 참조하십시오. link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - 스위치"^]에는 케이블 연결에 대한 자세한 정보도 포함되어 있습니다.
