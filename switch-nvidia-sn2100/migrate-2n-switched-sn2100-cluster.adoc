...
IMPORTANT: 을 참조하십시오 link:cabling-considerations-sn2100-cluster.html["케이블 연결 및 구성 고려 사항을 검토합니다"] 주의 사항 및 자세한 내용은 를 클릭합니다 https://["Hardware Universe - 스위치"^] 또한 케이블 연결에 대한 자세한 정보도 포함되어 있습니다.
