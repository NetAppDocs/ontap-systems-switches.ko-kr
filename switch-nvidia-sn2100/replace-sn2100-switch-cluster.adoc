...
summary: 클러스터 네트워크에서 결함이 있는 NVIDIA SN2100 클러스터 스위치를 교체합니다. 이 작업은 무중단 절차입니다. 
---
...
[role="lead"]
클러스터 네트워크에서 고장난 NVIDIA SN2100 클러스터 스위치를 클러스터 운영을 중단하지 않고 교체합니다. 이 비중단 교체 절차(NDU)는 교체 스위치를 준비하고 고장난 스위치에서 연결을 마이그레이션하는 과정을 포함합니다.
