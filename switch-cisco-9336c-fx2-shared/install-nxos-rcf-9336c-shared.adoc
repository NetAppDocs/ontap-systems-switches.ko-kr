...
[role="lead"]
Nexus 9336C-FX2 스위치를 처음 설정한 후 RCF(Reference Configuration File)를 설치할 수 있습니다.
...
* 스위치 간 ISL(Inter-Switch Link) 연결이 연결되어 있습니다.
...
.다음 단계
RCF를 설치한 후에는 다음을 수행할 수 있습니다. link:../switch-cshm/config-overview.html["스위치 상태 모니터링을 구성합니다"].
