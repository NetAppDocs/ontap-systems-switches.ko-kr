...
summary: '초기 설정 후 Cisco Nexus 9336C-FX2 공유 스위치에 참조 구성 파일(RCF)을 설치하여 결합된 클러스터 및 스토리지 운영을 위한 포트 할당을 구성하십시오.' 
---
= Cisco Nexus 9336C-FX2 공유 스위치에 RCF 설치
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
초기 설정 후 Cisco Nexus 9336C-FX2 공유 스위치에 참조 구성 파일(RCF)을 설치하십시오. RCF는 클러스터 및 스토리지 통합 운영을 위한 포트 할당을 구성합니다.
...
.사용 가능한 RCF 구성
* *ClusterStorageRCF* - 스위치에서 분할된 클러스터와 두 개의 스토리지 영역을 지원합니다(Cluster-Storage RCF 1._xx_).
