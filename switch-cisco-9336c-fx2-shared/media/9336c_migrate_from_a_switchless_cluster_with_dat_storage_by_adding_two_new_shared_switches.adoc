...
대부분의 시스템에는 각 컨트롤러에 전용 클러스터 네트워크 포트 2개가 필요합니다. 을 참조하십시오  https://["Cisco 이더넷 스위치"] 를 참조하십시오.
...
** 넷엡 https://["Hardware Universe"] 케이블 연결에 대한 자세한 내용은 에 나와 있습니다.
...
* 이 절차에 사용되는 클러스터 포트는 AFF A400 컨트롤러에 따라 _e3a_와 _e3b_입니다. 를 클릭합니다 https://["Hardware Universe"] 에는 해당 플랫폼의 실제 클러스터 포트에 대한 최신 정보가 나와 있습니다.
