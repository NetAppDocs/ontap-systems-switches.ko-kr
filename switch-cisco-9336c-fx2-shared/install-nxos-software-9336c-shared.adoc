...
summary: Cisco Nexus 9336C-FX2 공유 스위치에 NX-OS 소프트웨어를 설치하여 공유 클러스터 및 스토리지 운영을 위한 준비를 완료하십시오. 
---
= Cisco Nexus 9336C-FX2 공유 스위치에 NX-OS 소프트웨어를 설치합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 공유 스위치에 NX-OS 소프트웨어를 설치하여 공유 클러스터 및 스토리지 운영을 위한 준비를 완료하십시오.
