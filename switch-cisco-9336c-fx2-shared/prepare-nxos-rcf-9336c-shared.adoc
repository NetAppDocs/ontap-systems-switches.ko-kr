...
keywords:  
summary: 'NX-OS 소프트웨어와 참조 구성 파일(RCF)을 설치하기 전에 Cisco Nexus 9336C-FX2 공유 스위치를 준비하십시오.' 
---
= Cisco Nexus 9336C-FX2 공유 스위치에 NX-OS 소프트웨어 및 RCF를 설치할 준비를 하십시오.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
NX-OS 소프트웨어와 참조 구성 파일(RCF)을 설치하기 전에 Cisco Nexus 9336C-FX2 공유 스위치를 준비하십시오. 스위치가 ONTAP 환경에서 작동하려면 NX-OS와 RCF를 설치해야 합니다.
...
----
====
. 각 클러스터 인터페이스와 각 노드 스토리지 포트 및 스토리지 쉘프 포트의 관리 또는 운영 상태를 확인하십시오.
+
.. 네트워크 포트 속성을 표시합니다.
+
[source, cli]
