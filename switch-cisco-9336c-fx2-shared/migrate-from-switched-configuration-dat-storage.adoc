...
이 절차에서 지원되는 ONTAP 및 NX-OS 버전은 Cisco 이더넷 스위치 페이지에 있습니다. 을 참조하십시오 https://["Cisco 이더넷 스위치"].
...
를 클릭합니다 https://["Hardware Universe"] 모든 클러스터 스위치에 대해 지원되는 케이블 연결에 대한 정보를 제공합니다.
