...
[role="lead"]
EFOS 3.12.0.1부터 BES-53248 클러스터 스위치를 구성한 후 참조 구성 파일(RCF)과 라이선스 파일을 설치할 수 있습니다.
...
* 현재 RCF는 다음에서 사용 가능합니다. https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["Broadcom 클러스터 스위치"^] 페이지.
