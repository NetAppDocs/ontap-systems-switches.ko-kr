...
summary: 'Broadcom BES-53248 클러스터 스위치에서 SSH를 활성화하여 이더넷 스위치 상태 모니터링(CSHM) 및 로그 수집 기능을 지원하십시오.' 
---
= Broadcom BES-53248 클러스터 스위치에서 SSH 활성화
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248 클러스터 스위치에서 SSH를 활성화하여 이더넷 스위치 상태 모니터링(CSHM) 및 로그 수집 기능을 지원합니다. 이 절차에서는 SSH 키 생성 및 스위치에서 SSH 액세스 활성화 방법을 설명합니다.
