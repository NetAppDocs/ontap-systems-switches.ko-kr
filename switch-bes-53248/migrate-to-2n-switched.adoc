...
summary: Broadcom BES-53248 클러스터 스위치를 사용하여 2노드 스위치가 없는 클러스터를 스위치드 클러스터 환경으로 마이그레이션하여 2노드 이상으로 확장할 수 있습니다. 
---
= Broadcom BES-53248 클러스터 스위치를 사용하여 2노드 스위치 클러스터로 마이그레이션
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248 클러스터 스위치를 사용하여 기존의 2노드 스위치가 없는 클러스터를 스위치드 클러스터 환경으로 마이그레이션하십시오. 이 무중단 마이그레이션을 통해 클러스터를 2개 이상의 노드로 확장할 수 있습니다.
...
+
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^]에는 ONTAP 호환성, 지원되는 EFOS 펌웨어 및 BES-53248 스위치 케이블 연결에 대한 정보가 포함되어 있습니다. 스위치 설치 요구 사항에 대한 자세한 내용은 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["HWU에 없는 추가 정보 중 장비를 설치하는 데 필요한 정보는 무엇입니까?"^]를 참조하십시오.
...
+
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^]에는 사용 중인 플랫폼의 실제 클러스터 포트에 대한 최신 정보가 포함되어 있습니다.
...
+
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^]에는 케이블 연결에 대한 자세한 정보가 포함되어 있습니다.
