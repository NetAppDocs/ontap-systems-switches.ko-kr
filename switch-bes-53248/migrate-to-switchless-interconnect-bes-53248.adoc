...
summary: Broadcom BES-53248 클러스터 스위치를 사용하는 스위치 클러스터 네트워크에서 ONTAP 9.3 이상을 위한 2노드 스위치가 없는 클러스터 구성으로 마이그레이션하십시오. 
---
= Broadcom BES-53248 클러스터 스위치에서 스위치가 없는 클러스터 연결로 마이그레이션
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
