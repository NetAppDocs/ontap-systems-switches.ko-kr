...
summary: 'Broadcom BES-53248 클러스터 스위치에서 SNMPv3을 구성하여 이더넷 스위치 상태 모니터링(CSHM)과의 안전한 통신을 활성화하십시오.' 
---
= Broadcom BES-53248 클러스터 스위치에 대한 SNMPv3 구성
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248 클러스터 스위치에서 SNMPv3을 구성하여 이더넷 스위치 상태 모니터링(CSHM)과의 안전하고 인증된 통신을 활성화하십시오. SNMPv3은 ONTAP에서 상태 모니터링을 위한 스위치 상태의 암호화된 폴링을 제공합니다.
