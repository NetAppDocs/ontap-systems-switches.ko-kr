...
summary: Cisco Nexus 9808 스위치의 RCF를 업그레이드하여 AFX 2K 시스템의 새로운 하드웨어, 새로운 ONTAP 버전 또는 새로운 NX-OS 버전을 지원합니다. 
---
= Cisco Nexus 9808 스위치의 RCF 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9808 스위치의 참조 구성 파일(RCF)을 업그레이드하여 새로운 하드웨어, 새로운 ONTAP 버전 또는 AFX 2K 시스템의 새로운 NX-OS 버전을 지원합니다.
...
* 이 절차에 제시된 예시는 RCF 10.1을 실행하는 스위치가 있는 AFX 2K 시스템을 기준으로 합니다. 입력 및 출력은 사용 중인 RCF 버전에 따라 다를 수 있습니다.
...
+
Cisco 명령에 대한 자세한 내용은 link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html["Cisco Nexus 9000 시리즈 NX-OS 명령 참조"^]의 해당 가이드를 참조하십시오.
...
. ONTAP CLI를 사용하여 클러스터 LIF에서 자동 복원을 활성화합니다.
+
[source, cli]
----
