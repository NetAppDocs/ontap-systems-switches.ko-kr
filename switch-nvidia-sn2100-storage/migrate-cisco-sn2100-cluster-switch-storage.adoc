...
summary: 클러스터 운영을 중단하지 않고 기존 Cisco 클러스터 스위치에서 NVIDIA SN2100 클러스터 스위치로 마이그레이션하십시오. 
---
...
[role="lead"]
클러스터 운영을 중단하지 않고 Cisco 클러스터 스위치에서 NVIDIA SN2100 클러스터 스위치로 마이그레이션하십시오. 마이그레이션을 시작하기 전에 구성 정보, 포트 연결 및 케이블 요구 사항을 검토하십시오.
