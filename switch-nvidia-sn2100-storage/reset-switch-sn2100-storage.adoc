...
summary: NVIDIA SN2100 스토리지 스위치를 공장 기본값으로 재설정하려면 현재 스위치 구성을 지웁니다. 
---
= NVIDIA SN2100 스토리지 스위치를 공장 기본값으로 재설정
:allow-uri-read: 


[role="lead"]
NVIDIA SN2100 스토리지 스위치를 공장 기본값으로 재설정하려면 현재 스위치 구성을 지우고 스위치를 원래 설정으로 복원하십시오.
...
NOTE: Cumulus Linux 설치에 대한 자세한 내용은 link:configure-software-sn2100-storage.html["NVIDIA SN2100 스위치용 소프트웨어 설치 워크플로"]을 참조하십시오.
...
자세한 내용은 NVIDIA https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["공장 초기화"^] 설명서를 참조하십시오.

--
====
.다음은 무엇입니까?
스위치를 재설정한 후에는 다음을 수행할 수 있습니다.link:configure-overview-sn2100-storage.html["재구성하다"] 필요에 따라.
