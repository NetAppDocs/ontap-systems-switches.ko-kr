...
summary: NVIDIA SN2100 스토리지 스위치에서 SNMPv3을 구성하여 안전한 스위치 로그 수집 및 상태 모니터링을 활성화하십시오. 
---
= NVIDIA SN2100 스토리지 스위치용 SNMPv3 구성
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NVIDIA SN2100 스토리지 스위치에서 SNMPv3을 구성하여 안전하고 인증된 스위치 로그 수집 및 이더넷 스위치 상태 모니터링(CSHM)을 활성화하십시오.
...
----
====
. 새로운 SNMPv3 사용자로 모니터링하도록 SHM을 구성합니다.
+
...
----
====
. SHM 폴링 기간이 완료되면 새로 생성된 SNMPv3 사용자에게 쿼리할 일련 번호가 이전 단계에서 자세히 설명한 것과 동일한지 확인합니다.
+
