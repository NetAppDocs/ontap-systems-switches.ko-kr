...
summary: 이 릴리스에는 로그 모니터링을 위한 SNMPv3 지원이 포함되어 있습니다. 
---
= 스위치 로그 수집을 위해 SNMPv3 구성
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
스위치 로그 수집 및 스위치 상태 모니터링(SHM)을 지원하는 SNMPv3를 구성하려면 다음 절차를 따르세요.
...
다음 명령은 SHM을 사용하여 SNMPv3 사용자 이름을 설정합니다.
