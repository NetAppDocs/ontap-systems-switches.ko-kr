...
summary: '초기 설정 후 Cisco Nexus 3132Q-V 클러스터 스위치에 참조 구성 파일(RCF)을 설치하십시오.' 
---
= Cisco Nexus 3132Q-V 클러스터 스위치에 RCF 설치
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
초기 설정 후 Cisco Nexus 3132Q-V 클러스터 스위치에 참조 구성 파일(RCF)을 설치하십시오. RCF는 클러스터 작동에 필요한 포트 할당 및 네트워크 설정을 정의합니다.
...
+
자세한 내용은 link:https://kb.netapp.com/on-prem/Switches/Cisco-KBs/How_to_clear_configuration_on_a_Cisco_interconnect_switch_while_retaining_remote_connectivity["원격 연결을 유지하면서 Cisco 상호 연결 스위치의 구성을 지우는 방법"^]을 참조하십시오.
...
link:https://docs.netapp.com/us-en/ontap/task_configure_ontap.html["System Manager를 사용하여 새 클러스터에 ONTAP 구성"]의 설치 지침을 참조하십시오.
