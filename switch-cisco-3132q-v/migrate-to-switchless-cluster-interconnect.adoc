...
---
= Cisco Nexus 3132Q-V 클러스터 스위치를 스위치리스 연결로 교체
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ONTAP 9.3 이상에서는 스위치드 클러스터 네트워크가 있는 클러스터에서 두 노드가 직접 연결된 클러스터로 마이그레이션할 수 있습니다.

[NOTE]
====
NetApp Cisco Nexus 3132Q-V 스위치에 대한 스위치리스 클러스터 작업을 진행하기 전에 ONTAP 버전을 업데이트할 것을 권장합니다.
