...
summary: '클러스터 네트워크에서 결함이 있는 Cisco Nexus 3132Q-V 스위치를 교체하는 것은 무중단 절차(NDU)이며 특정 작업 순서를 수행해야 합니다.' 
---
...
[role="lead"]
클러스터 네트워크에서 결함이 있는 Cisco Nexus 3132Q-V 스위치를 교체하려면 다음 절차를 따르십시오. 이 교체 절차는 네트워크 중단 없이 진행되는 절차(NDO)입니다.
