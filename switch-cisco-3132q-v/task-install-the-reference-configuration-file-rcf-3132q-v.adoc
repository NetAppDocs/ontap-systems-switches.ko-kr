...
summary: Nexus 3132Q-V 스위치를 처음 설정한 후 RCF를 설치할 수 있으며, 이 절차를 사용하여 RCF 버전을 업그레이드할 수도 있습니다. 
---
...
[role="lead"]
Nexus 3132Q-V 스위치를 처음 설정한 후 RCF를 설치할 수 있습니다. 이 절차를 사용하여 RCF 버전을 업그레이드할 수도 있습니다.
...
----
+
이 명령을 실행한 후 자동 복귀가 해제되어 있는지 확인합니다.
...
+
이 예에서는 RCF 파일 "Nexus_3132QV_RCF_v1.6 - Cluster-HA-Breakout.txt"가 스위치 CS2에 설치되어 있음을 보여 줍니다.
