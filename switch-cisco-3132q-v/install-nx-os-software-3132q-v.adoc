...
summary: 클러스터 운영을 위해 Cisco Nexus 3132Q-V 클러스터 스위치에 NX-OS 소프트웨어를 설치하십시오. 
---
= Cisco Nexus 3132Q-V 클러스터 스위치에 NX-OS 소프트웨어 설치
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
클러스터 운영을 위해 Cisco Nexus 3132Q-V 클러스터 스위치에 NX-OS 소프트웨어를 설치하십시오.
...
.제안된 문서
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco 이더넷 스위치"^]. 지원되는 ONTAP 및 NX-OS 버전은 스위치 호환성 표를 참조하십시오.
* https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 시리즈 스위치"^]. Cisco 스위치 업그레이드 및 다운그레이드 절차에 대한 전체 설명서는 Cisco 웹 사이트에서 제공되는 해당 소프트웨어 및 업그레이드 가이드를 참조하십시오.
...
link:prepare-install-cisco-nexus-3132q.html["NX-OS 소프트웨어 및 참조 구성 파일 설치 준비"]의 절차를 완료한 후 아래 단계를 따르십시오.
...
. FTP, TFTP, SFTP 또는 SCP와 같은 전송 프로토콜 중 하나를 사용하여 NX-OS 소프트웨어를 Nexus 3132Q-V 스위치에 복사하십시오. Cisco 명령에 대한 자세한 내용은 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 Series NX-OS Command Reference"^]의 해당 가이드를 참조하십시오.
+
.예를 보여주세요
[%collapsible]
====
...
.다음은 무엇인가요?
NX-OS 소프트웨어를 설치한 후 link:install-upgrade-rcf-overview-3132q-v.html["참조 구성 파일(RCF) 설치 또는 업그레이드"]할 수 있습니다.
