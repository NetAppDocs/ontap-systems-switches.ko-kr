...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["하나"]link:setup-switch-9332d-cluster.html["9332D-GX2B 스위치 구성"]
[role="quick-margin-para"]
Cisco 9332D-GX2B 스위치를 구성합니다.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["둘"]link:install-nxos-overview-9332d-cluster.html["NX-OS 소프트웨어 및 RCF 설치를 준비하세요"]
[role="quick-margin-para"]
Cisco 9332D-GX2B 스위치에 Cisco NX-OS 소프트웨어와 참조 구성 파일(RCF)을 설치합니다.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["삼"]link:install-nxos-software-9332d-cluster.html["NX-OS 소프트웨어 설치 또는 업그레이드"]
[role="quick-margin-para"]
...
[role="quick-margin-para"]
Cisco 9332D-GX2B 스위치에서 CSHM(Ethernet Switch Health Monitor) 및 로그 수집 기능을 사용하려면 SSH가 활성화되어 있는지 확인하세요.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["육"]link:reset-switch-9332d.html["스위치를 공장 기본값으로 재설정합니다"]
[role="quick-margin-para"]
