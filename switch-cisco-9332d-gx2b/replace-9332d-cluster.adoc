...
summary: '클러스터 네트워크에서 결함이 있는 Nexus 9332D-GX2B 스위치를 교체하는 것은 중단 없는 절차(NDU)입니다.' 
---
...
** 스위치의 초기 사용자 정의가 완료되었습니다.link:setup-switch-9332d-cluster.html["9332D-GX2B 클러스터 스위치 구성"] .
+
