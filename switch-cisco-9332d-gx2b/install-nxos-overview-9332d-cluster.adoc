...
summary: 'Cisco NX-OS 소프트웨어와 RCF(Reference Configuration File)는 Cisco Nexus 9332D-GX2B 클러스터 스위치에 설치해야 합니다.' 
---
...
.. *클러스터 포트*
+
... 각 스위치에 대해 각 노드에 구성된 클러스터 상호 연결 인터페이스 수를 표시합니다.
+
[source, cli]
----
...
.다음은 무엇인가요?
NX-OS 소프트웨어와 RCF를 설치할 준비가 되면 link:install-nxos-software-9332d-cluster.html["NX-OS 소프트웨어를 설치하거나 업그레이드하세요"].
